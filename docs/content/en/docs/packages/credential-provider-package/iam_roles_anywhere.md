...
This tutorial does not apply to Bottlerocket because of [an issue when executing the credential_process command on Bottlerocket](https://github.com/aws/aws-sdk-go-v2/issues/2879).
{{% /alert %}}
